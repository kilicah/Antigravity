...
import AccountingInvoiceDocument from "@/components/orders/AccountingInvoiceDocument";

export default async function AccountingInvoiceViewPage({
  params,
}: {
  ...
  // Fetch default bank info (we may not need it for accounting, but we can pass it)
  ...
  return (
    <div className="max-w-[1020px] mx-auto space-y-6">
      ...
      <div className="flex justify-between items-center print:hidden mb-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Accounting Voucher / Muhasebe Fişi</h1>
      ...
      <div className="bg-white shadow-2xl print:shadow-none flex justify-center pb-12 print:pb-0">
         <AccountingInvoiceDocument order={order} bankInfo={bankInfo}  />
      </div>
