                  ...
                  filteredProducts.map((p) => {
                    ...
                    return (
                      <tr key={p.id} onClick={() => handleCheckboxChange(p.id)} className={`transition-colors group cursor-pointer ${isSelected ? 'bg-indigo-50/60' : 'hover:bg-slate-50'}`}>
                        ...
                        <td className="py-3 px-4 text-sm font-semibold text-slate-800 whitespace-normal min-w-[200px]">
                           {p.name || "-"}
                           {p.status !== 'ACTIVE' && p.updatedAt && (
                              <div className="text-[10px] text-red-500 mt-1 font-bold">
                                 {p.status === 'PASSIVE' ? 'Pasife Alındı: ' : 'İptal Edildi: '} {new Date(p.updatedAt).toLocaleDateString("tr-TR")}
                              </div>
                           )}
                        </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
               ...
               <form id="productForm" onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                     <div>
                        ...
                        <input required type="text" value={formData.code} onChange={e => setFormData({...formData, code: e.target.value})} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all font-mono" />
                     </div>
                     <div>
                        <label className="block text-[12px] font-bold text-slate-500 mb-1.5 uppercase tracking-wide">Adı / Kalitesi *</label>
                        <input required type="text" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all font-bold" />
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                     <div className="md:col-span-3">
                        ...
                        <input type="text" value={formData.composition} onChange={e => setFormData({...formData, composition: e.target.value})} placeholder="%100 Pamuk vb." className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-slate-800 transition-all" />
                     </div>
                     <div>
                        <label className="block text-[12px] font-bold text-slate-500 mb-1.5 uppercase tracking-wide">Ağırlık</label>
                        <input type="text" value={formData.weight} onChange={e => setFormData({...formData, weight: e.target.value})} placeholder="150 gr/m2" className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-slate-800 transition-all" />
                     </div>
                     <div>
                        <label className="block text-[12px] font-bold text-slate-500 mb-1.5 uppercase tracking-wide">En</label>
                        <input type="text" value={formData.width} onChange={e => setFormData({...formData, width: e.target.value})} placeholder="150 cm" className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-slate-800 transition-all" />
                     </div>
                     <div>
                        <label className="block text-[12px] font-bold text-slate-500 mb-1.5 uppercase tracking-wide">GTİP No</label>
                        <input type="text" value={formData.gtipNo} onChange={e => setFormData({...formData, gtipNo: e.target.value})} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-slate-800 transition-all font-mono" />
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 mb-5">
                     <div className="bg-rose-50/50 p-2 rounded-lg border border-rose-100 flex flex-col justify-between">
                        ...
                        <input type="number" step="0.01" value={formData.costPrice} onChange={e => setFormData({...formData, costPrice: e.target.value})} className="w-full bg-white border border-rose-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-rose-500 transition-all font-mono text-sm" />
                     </div>
                     <div>
                        ...
                        <input type="number" step="0.01" value={formData.priceTier1} onChange={e => handleTierChange("priceTier1", e.target.value)} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-emerald-500 transition-all font-mono text-sm" />
                     </div>
                     <div>
                        ...
                        <input type="number" step="0.01" value={formData.priceTier2} onChange={e => handleTierChange("priceTier2", e.target.value)} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-emerald-500 transition-all font-mono text-sm" />
                     </div>
                     <div>
                        ...
                        <input type="number" step="0.01" value={formData.priceTier3} onChange={e => handleTierChange("priceTier3", e.target.value)} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-emerald-500 transition-all font-mono text-sm" />
                     </div>
                     <div>
                        ...
                        <input type="number" step="0.001" value={formData.poundPrice} onChange={e => setFormData({...formData, poundPrice: e.target.value})} className={`w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-blue-500 transition-all font-mono text-sm ${autoCalc ? 'bg-blue-50/50' : ''}`} />
                     </div>
                     <div>
                        ...
                        <input type="number" step="0.001" value={formData.euroPrice} onChange={e => setFormData({...formData, euroPrice: e.target.value})} className={`w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-blue-500 transition-all font-mono text-sm ${autoCalc ? 'bg-blue-50/50' : ''}`} />
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-5 mb-6">
                     <div>
                        ...
                        <input type="number" step="0.01" value={formData.tMoq} onChange={e => setFormData({...formData, tMoq: parseFloat(e.target.value) || 0})} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-slate-800 transition-all" />
                     </div>
                     <div>
                        <label className="block text-[12px] font-bold text-slate-500 mb-1.5 uppercase tracking-wide">Renk MOQ (MCQ)</label>
                        <input type="number" step="0.01" value={formData.mcq} onChange={e => setFormData({...formData, mcq: parseFloat(e.target.value) || 0})} className="w-full bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-slate-800 transition-all" />
                     </div>
                     <div>
             ...
             <div className="flex justify-end gap-3 p-5 border-t border-slate-200 bg-slate-50 shrink-0">
                <button type="button" onClick={() => setIsModalOpen(false)} className="px-6 py-2.5 rounded-lg border border-slate-300 text-slate-600 font-bold hover:bg-slate-100 transition-colors">Kapat</button>
                <button type="submit" form="productForm" disabled={isSubmitting} className="px-8 py-2.5 rounded-lg bg-blue-600 text-white font-bold hover:bg-blue-700 transition-all shadow-md">
