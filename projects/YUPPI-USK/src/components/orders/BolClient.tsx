        ...
        <div className="w-[1002px] shrink-0 bg-white text-black font-['Arial',_'Helvetica',_sans-serif] text-[12px] leading-tight border-2 border-black relative box-border">
          ...
          <div className="grid grid-cols-[400px_400px_198px] border-b-2 border-black">
            ...
            <div className="border-r-2 border-black p-2 flex flex-col h-[135px]">
               ...
               <div className="font-bold uppercase text-[12px]">{isEng && seller?.nameEn ? seller?.nameEn : (seller?.name || "USK TEKSTİL SANAYİ VE TİCARET LİMİTED ŞİRKETİ")}</div>
          ...
          <div className="grid grid-cols-[400px_400px_198px] border-b-2 border-black">
            ...
            <div className="flex flex-col h-[135px]">
                ...
                <div className="h-[45px] flex flex-col justify-center px-4 leading-snug">
                    ...
                    <div className="text-[12px] uppercase">{Array.from(new Set(invoice.items.map((i: any) => i.orderItem.order.buyerPoNo).filter(Boolean))).join(', ') || "-"}</div>
                </div>
            </div>
          </div>

          <div className="grid grid-cols-[400px_598px] border-b-2 border-black min-h-[90px]">
            {/* TRANSPORTER COMPANY */}
            <div className="p-2 border-r border-black relative">
               <div className="font-bold underline uppercase mb-1 text-[13px]">{t.transporterComp}</div>
               <div className="font-bold uppercase text-[12px]">{invoice.logisticsCompany?.name || firstOrder?.transporter || "-"}</div>
               ...
               <div className="text-purple-800 font-bold underline block mt-1 uppercase">alper.gundogdu@dachser.com / M. +90 549 6630551</div>
            </div>

            {/* CUSTOM AGENCY */}
            <div className="p-2 relative border-b-0 border-black">
               <div className="font-bold underline uppercase mb-1 text-[13px]">{t.customAgency}</div>
               <div className="uppercase text-[12px]">{invoice.customsCompany?.name || "HGL GUMRUK MUSAVIRLIGI LOJ. VE DIS TICARET A.S."}</div>
          ...
          {/* DETAILS GRID */}
          <div className="grid grid-cols-[300px_1fr] border-b-2 border-black font-bold uppercase text-[12px] leading-snug">
             ...
             <div className="border-b border-black grid grid-cols-[1fr_200px_1fr]">
             ...
             <div className="border-b border-black grid grid-cols-[1fr_80px_200px_1fr]">
          ...
          <div className="text-center font-bold text-[13px] uppercase tracking-wider p-3">
             {t.turkishOrigin}
          </div>
        </div>
      </div>
