...
export default function CommercialInvoicePortrait2({ order, bankInfo, repUser }: { order: any; bankInfo: any; repUser?: any }) {
  ...
  return (
    <div className="w-full flex flex-col items-center print:p-[10mm]">
      ...
      <div className="w-[794px] bg-white text-black font-['Arial',_'Helvetica',_sans-serif] text-[11px] leading-tight border border-black relative">
        ...
        <div className="grid grid-cols-[315px_315px_158px] border-b border-black">
          ...
          <div className="border-r border-black p-2 flex justify-center items-center h-[135px]">
              <h1 className="text-[#d81e1e] font-sans font-bold text-[30px] text-center leading-tight tracking-wider uppercase">
                {isEng ? (
          ...
          <div className="p-2 flex justify-center items-center h-[135px]">
               {isUSKM ? (
                 <img src="/images/Defenni-M-Kirmizi.jpg" alt="Logo" className="max-h-[84px] max-w-[188px] object-contain mix-blend-multiply" />
               ) : isUSKT ? (
                 <img src="/images/Defenni-T-Kirmizi.jpg" alt="Logo" className="max-h-[84px] max-w-[188px] object-contain mix-blend-multiply" />
               ) : sellerName.includes("DEFENNİ") || sellerName.includes("DEFENNI") ? (
                 <img src="/defenni-logo.png" alt="Logo" className="max-h-[84px] max-w-[188px] object-contain mix-blend-multiply" />
               ) : (
        ...
        <div className="grid grid-cols-[315px_315px_158px] border-b border-black">
          ...
          <div className="border-r border-black p-2 flex flex-col h-[135px] leading-snug">
             <div className="font-bold underline uppercase mb-0.5 text-[11px]">{t.customerTitle}</div>
        ...
        <div className="w-full">
          <table className="w-full text-center table-fixed border-collapse">
            <thead>
              <tr className="border-b border-black font-bold uppercase text-[11px] leading-tight">
        ...
        {/* AMOUNT IN WORDS */}
        <div className="border-t border-b border-black py-2 px-1 flex items-center">
        ...
        <div className="flex flex-col border-b border-black">
           ...
           {/* Origin Title Row */}
           <div className="grid grid-cols-[450px_1fr]">
              <div className="border-r border-black min-h-[30px]"></div>
              <div className="font-bold text-center uppercase py-1">
                {t.originDecl}
              </div>
           </div>

           {/* Signature & Origin Text Row */}
           <div className="grid grid-cols-[450px_1fr] border-t border-black">
              <div className="border-r border-black flex flex-col items-center pt-3 font-bold tracking-wide text-[11px] min-h-[65px] uppercase relative">
                 <div className="z-10">{t.authSign}</div>
                 
                 {/* STAMP */}
                 {isSigned && (
                   <div className="absolute top-[30px] left-10 z-0">
                     {isUSKM ? (
                       <img src="/images/USKM-Kase-Imza.png" alt="Stamp" className="w-[240px] object-contain opacity-90 mix-blend-multiply filter contrast-125 sepia-[0.3]" />
                     ) : isUSKT ? (
                       <img src="/images/USKT-Kase-Imza.png" alt="Stamp" className="w-[240px] object-contain opacity-90 mix-blend-multiply filter contrast-125 sepia-[0.3]" />
                     ) : sellerName.includes("DEFENNİ") || sellerName.includes("DEFENNI") ? (
                        <img src="/defenni-logo.png" alt="Stamp" className="w-[240px] object-contain opacity-90 mix-blend-multiply grayscale" />
                     ) : (
              ...
              <div className="p-2 text-[11px] text-justify leading-snug flex items-center">
